% NOTE: The below 'magic comments' are instructions for TeXStudio and similar
%       editors. See README for detailed instructions on how to build this
%       template and how to do so in TeXStudio.
